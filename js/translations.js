const translations = {
  en: {
    ...
    "faq.q1.answer": "The 3-day celebration (Sept 11-13) is for guests staying at the venue hotel, which we've reserved exclusively for our wedding. If you're not staying at the hotel, you're warmly invited to join us for the ceremony on September 12th at 4:30 PM - please plan to arrive after 3pm.",
    ...
    "rsvp.childrenPaying": "Children (5-12 years)",
    "rsvp.childrenFree": "Children (under 5)",
    ...
    "rsvp.contactHint": "Either one is enough - email or phone.",
    "rsvp.contactHintOptional": "Optional - only if you'd like us to stay in touch.",
  ...
  pt: {
    ...
    "faq.q1.answer": "A celebração de 3 dias (11-13 de Set) é para os hóspedes que ficarão no hotel do evento, que reservamos exclusivamente para nosso casamento. Se você não ficará hospedado no hotel, está convidado a participar da cerimônia no dia 12 de setembro às 16h30 - por favor chegue após às 15h.",
    ...
    "rsvp.childrenPaying": "Crianças (5-12 anos)",
    "rsvp.childrenFree": "Crianças (menores de 5)",
    ...
    "rsvp.contactHint": "Apenas um é suficiente - email ou telefone.",
    "rsvp.contactHintOptional": "Opcional - apenas se quiser manter contato.",
